...
struct sample samples[] = {
	{.text = "www.example.com", .textLen = 15, .code = code0, .codeLen = 12},
	{.text = "no-cache", .textLen = 8, .code = code1, .codeLen = 6},
	{.text = "custom-key", .textLen = 10, .code = code2, .codeLen = 8},
	{.text = "custom-value", .textLen = 12, .code = code3, .codeLen = 9},
	{.text = "private", .textLen = 7, .code = code4, .codeLen = 5},
	{.text = "Mon, 21 Oct 2013 20:13:21 GMT", .textLen = 29, .code = code5, .codeLen = 22},
	{.text = "https://www.example.com", .textLen = 23, .code = code6, .codeLen = 17},
	{.text = "307", .textLen = 3, .code = code7, .codeLen = 3},
	{.text = "foo=ASDJKHQKBZXOQWEOPIUAXQWEOIU; max-age=3600; version=1", .textLen = 56, .code = code8, .codeLen = 45},
};
